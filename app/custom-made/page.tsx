  ...
  return (
    <div className="min-h-screen bg-[#f4e5e9] text-[#211815]">
      <section className="mx-auto max-w-[1320px] px-6 pb-20 pt-16 text-center md:px-12 md:pb-28 md:pt-24">
        <h1 className="brand-script text-5xl md:text-8xl">Custom Made</h1>
        <p className="mx-auto mt-10 max-w-2xl font-serif text-xs uppercase leading-6 tracking-[0.06em] md:text-sm md:leading-7">Our jewelry is available custom made to order, crafted to suit your individual taste rather than a one-size-fits-all approach.<br /><br />Choose your own colour, size, or add a name engraved on the piece.</p>
        <Link href="/contact" className="mt-10 inline-block bg-black px-8 py-4 text-[10px] tracking-[0.18em] text-white">CREATE YOURS</Link>
